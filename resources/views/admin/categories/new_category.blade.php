<x-admin_layout>
    <x-slot:pageTitle>New Category</x-slot:pageTitle>
    <div class="w-full flex mt-10">
        <form action="/admin/categories" method="POST" class="w-full flex flex-col">
            @csrf
            <h1 class="text-2xl mt-2 mb-4 font-bold uppercase ">Add new category</h1>
